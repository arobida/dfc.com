  ...
  <React.Fragment>
    ...
    <Parallax pages={5}>
      <Divider speed={0.2} offset={0}>
        <UpDown>
        <img src={heart} width={48} style={{marginLeft:"40px", marginTop:"30px"}}/>
          <img src={music}  style={{marginLeft:"60%", marginTop:"70%"}} />
          <img src={home} width={6} style={{marginLeft:"60%", marginTop:"15%"}} />
        </UpDown>
        <UpDownWide>
          <img src={home} width={16} style={{marginLeft:"80%", marginTop:"10%"}} />
        ...
        <img src={home} width={8} style={{marginLeft:"80%", marginTop:"70%"}} />
      </Divider>
      <Content speed={0.4} offset={0}>
        <Hero>
          ...
          <Subtitle>I'm the Head Chef and Owner of Davis Family Catering based in <strong itemProp="location" itemScope itemType="https://schema.org/Place">San Diego, California</strong> area. I am a small business hoping to share some of our family values and cooking with yours.</Subtitle>
        </Hero>
      </Content>
      <DividerMiddle
      ...
      <Content speed={0.4} offset={4}>
        <Inner>
          ...
          <ContactText>
            Say <a href="mailto:davis_catering@yahoo.com">Hi</a> or find me on other platforms:{' '}
            <a href="https://www.facebook.com/Davisfamilycatering" target="_blank" rel="noopener noreferrer">Facebook</a> &{' '}
            <a href="https://www.instagram.com/davisfamilycatering" target="_blank" rel="noopener noreferrer">Instagram</a>
          </ContactText>
        </Inner>
        <Footer>
          &copy; 2018 Davis Family Catering.
        </Footer>
      </Content>
      <Divider speed={0.1} offset={4}>
        <UpDown>
        <img src={phone} style={{marginLeft:"70%", marginTop:"20%"}}/>
        <img src={facebook} width={30} style={{marginLeft:"80%", marginTop:"70%"}}/>
          <SVG icon="triangle" width={8} stroke={colors['grey-darkest']} left="25%" top="5%" />
        </UpDown>
        <UpDownWide>
          <SVG icon="triangle" width={12} stroke={colors.white} left="95%" top="50%" />
